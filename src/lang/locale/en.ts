...
export default {
  ...
  GRID_MENU_ENABLE: "Enable Grid",
  GRID_MENU_PATTERN: "Pattern",
  GRID_MENU_COLOR: "Color",
  SQUARED_PAPER_HEAD: "Grid Background",
  SQUARED_PAPER_ENABLE_NAME: "Enable Grid Background",
  SQUARED_PAPER_ENABLE_DESC: "Toggle to enable or disable the background grid pattern.",
  SQUARED_PAPER_PATTERN_NAME: "Grid Pattern",
  SQUARED_PAPER_PATTERN_DESC: "Choose the type of grid pattern to display.",
  SQUARED_PAPER_PATTERN_GRID: "Grid (Squares)",
  SQUARED_PAPER_PATTERN_LINES_H: "Horizontal Lines",
  SQUARED_PAPER_PATTERN_LINES_V: "Vertical Lines",
  SQUARED_PAPER_PATTERN_DOTS: "Dot Grid",
  SQUARED_PAPER_PATTERN_ISOMETRIC: "Isometric Grid",
  SQUARED_PAPER_COLOR_NAME: "Grid Color",
  SQUARED_PAPER_COLOR_DESC: "Set the color of the grid lines or dots.",
  SQUARED_PAPER_SIZE_NAME: "Grid Spacing",
  SQUARED_PAPER_SIZE_DESC: "Set the spacing between grid lines or dots in pixels.",
