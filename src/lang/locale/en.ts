...
export default {
  ...
  SQUARED_PAPER_HEAD: "Squared Paper",
  SQUARED_PAPER_ENABLE_NAME: "Enable Squared Paper",
  SQUARED_PAPER_ENABLE_DESC: "Toggle to enable or disable the squared paper background.",
  SQUARED_PAPER_COLOR_NAME: "Squared Paper Color",
  SQUARED_PAPER_COLOR_DESC: "Set the color of the squared paper lines.",
  SQUARED_PAPER_SIZE_NAME: "Squared Paper Size",
  SQUARED_PAPER_SIZE_DESC: "Set the size of the squares in pixels.",
